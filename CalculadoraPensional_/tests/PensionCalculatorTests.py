...
import sys 
sys.path.append("src")
from Pension_Calculator.pension_calculator import calcular_pension, edad_negativa, saldo_negativo, rentabilidad_negativa, administracion_negativa, semanas_insuficientes, edad_insuficiente, rentabilidad_superior_cien, semanas_negativas, sexo_invalido
